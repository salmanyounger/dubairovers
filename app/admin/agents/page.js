              ...
              <tbody>
                {filtered.map((a,i)=>(
                  <tr key={a.id} onClick={()=>setSelected(a)}
                    ...
                    <td className="px-4 py-3 font-bold text-brand-gold">AED {a.earnings?.toLocaleString('en-US')||0}</td>
                    <td className="px-4 py-3">
            ...
            <div className="rounded-2xl bg-white overflow-hidden sticky top-24"
              ...
              <div className="p-4 space-y-2.5 text-xs">
                {[['👤 Name',selected.name],['📱 Phone',selected.phone],['📧 Email',selected.email],['🎯 Specialty',selected.specialty],
                  ...
                  ['📋 Bookings',selected.bookings],['💰 Earnings',`AED ${selected.earnings?.toLocaleString('en-US')||0}`],
