...
export default function MobileAppNav() {
  ...
  // Inject CSS via useEffect so it cleans up properly on unmount — no crash
  useEffect(() => {
    const id = "mob-app-nav-styles";
    ...
    // No cleanup — this nav is in the global layout, styles should persist
  }, []);
