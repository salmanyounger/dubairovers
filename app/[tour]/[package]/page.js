...
export default function PackagePage({ params }) {
  ...
  if (!tour || !pkg) return (
    <div suppressHydrationWarning className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center">
  ...
  return (
    <div suppressHydrationWarning className="min-h-screen bg-[#0a0a0a] text-white">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                  {pkg.included.filter(item => item.startsWith("✅")).map((item, i) => {
                    ...
                    return (
    <div suppressHydrationWarning key={i} className="flex items-center gap-3 bg-green-500/10 border border-green-500/20 rounded-2xl px-4 py-3 hover:bg-green-500/15 hover:scale-[1.02] transition-all duration-300"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {pkg.included.filter(item => item.startsWith("❌")).map((item, i) => {
                    ...
                    const icon = getIncludedIcon(text);
                    return (
    <div suppressHydrationWarning key={i} className="flex items-center gap-3 bg-red-500/10 border border-red-500/20 rounded-2xl px-4 py-3 transition-all duration-300"
