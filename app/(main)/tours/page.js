...
export default function ToursPage() {
  ...
  return (
    <>
      ...
      {/* Worldwide Tours Banner */}
      <section className="py-14" style={{ background: 'linear-gradient(135deg,#0A1628,#1E3A5F)' }}>
        <div className="container-main text-center">
          <span className="badge-gold mb-4 inline-block">🌍 Beyond UAE</span>
          <h2 className="text-3xl font-black text-white mb-3" style={{ fontFamily: "'Playfair Display',serif" }}>
            Explore 50 Countries Worldwide
          </h2>
          <p className="text-white/70 mb-6 max-w-xl mx-auto">
            Jordan, Maldives, Japan, France, Pakistan, Kenya and 44 more — book international tours from Dubai with the same trusted team.
          </p>
          <Link href="/tours/worldwide" className="btn-gold">
