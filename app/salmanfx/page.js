    ...
    <>
      ...
      <div suppressHydrationWarning style={{ minHeight:"100vh", overflowX:"hidden", background:T.bg, color:T.text, fontFamily:"'Plus Jakarta Sans',sans-serif" }}>
        ...
        @media(max-width:768px){
          ...
          .sfx-pricing-grid{grid-template-columns:1fr!important;gap:16px!important;}
        }
        ...
        {/* HERO */}
        <div style={{ background:"linear-gradient(135deg,rgba(16,185,129,0.08) 0%,transparent 60%)", borderBottom:`1px solid ${T.border}`, padding:"52px 24px 44px", display: tab !== "overview" ? "none" : "block" }}>
